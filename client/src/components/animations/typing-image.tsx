  ...
  return (
    <motion.div
      style={{
        overflow: "hidden",
        position: "relative",
        width: "250x", // Adjust the width as needed
        height: "36px", // Adjust the height as needed
        z: 0,
        
      }}
      initial={{ width: "220px", opacity: 0, x: -100}} // Initially, the image is fully off-screen to the right
      animate={{ width: "220px", opacity: 1, x: 0 }} // Animate to x: 0, revealing the image
